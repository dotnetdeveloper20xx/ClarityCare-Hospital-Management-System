...
namespace ClarityCare.Infrastructure.Migrations
{
    ...
    public partial class AddPerformanceIndexesAndConstraints : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PatientAddresses_PatientId_IsPrimary",
                table: "PatientAddresses",
                columns: new[] { "PatientId", "IsPrimary" });

            migrationBuilder.CreateIndex(
                name: "IX_NursingTasks_DueAt",
                table: "NursingTasks",
                column: "DueAt");

            migrationBuilder.CreateIndex(
                name: "IX_NursingTasks_PatientId_Status",
                table: "NursingTasks",
                columns: new[] { "PatientId", "Status" });

            migrationBuilder.CreateIndex(
                name: "IX_NursingTasks_WardId_Status",
                table: "NursingTasks",
                columns: new[] { "WardId", "Status" });

            migrationBuilder.CreateIndex(
                name: "IX_ClinicalAlerts_PatientId_Status",
                table: "ClinicalAlerts",
                columns: new[] { "PatientId", "Status" });

            migrationBuilder.CreateIndex(
                name: "IX_ClinicalAlerts_Status_Severity",
                table: "ClinicalAlerts",
                columns: new[] { "Status", "Severity" });

            migrationBuilder.CreateIndex(
                name: "IX_ClinicalAlerts_WardId_Status",
                table: "ClinicalAlerts",
                columns: new[] { "WardId", "Status" });
