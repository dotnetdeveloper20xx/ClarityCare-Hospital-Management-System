    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MedicationCatalogs", x => x.MedicationId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HospitalNumber = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AppointmentTypes_Departments_DepartmentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ServiceCatalogues", x => x.ServiceId);
                    table.ForeignKey(
                        name: "FK_ServiceCatalogues_Departments_DepartmentId",
                        column: x => x.DepartmentId,
                        principalTable: "Departments",
                        principalColumn: "DepartmentId");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_IntegrationMessages", x => x.MessageId);
                    table.ForeignKey(
                        name: "FK_IntegrationMessages_IntegrationEndpoints_EndpointId",
                        column: x => x.EndpointId,
                        principalTable: "IntegrationEndpoints",
                        principalColumn: "IntegrationEndpointId",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    GPDetailsId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    PatientId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GPDetails", x => x.GPDetailsId);
                    table.ForeignKey(
                        name: "FK_GPDetails_Patients_PatientId",
                        column: x => x.PatientId,
                        principalTable: "Patients",
                        principalColumn: "PatientId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PatientAddressId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    PatientId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PatientAllergyId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    PatientId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PatientForms", x => x.PatientFormId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PortalUsers_Patients_PatientId",
                        column: x => x.PatientId,
                        principalTable: "Patients",
                        principalColumn: "PatientId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    WaitingListEntryId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    PatientId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    DepartmentId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    AppointmentTypeId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WaitingListEntries_AppointmentTypes_AppointmentTypeId",
                        column: x => x.AppointmentTypeId,
                        principalTable: "AppointmentTypes",
                        principalColumn: "AppointmentTypeId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_WaitingListEntries_Departments_DepartmentId",
                        column: x => x.DepartmentId,
                        principalTable: "Departments",
                        principalColumn: "DepartmentId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_InvoiceItems_ServiceCatalogues_ServiceId",
                        column: x => x.ServiceId,
                        principalTable: "ServiceCatalogues",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PortalNotifications", x => x.NotificationId);
                    table.ForeignKey(
                        name: "FK_PortalNotifications_PortalUsers_PortalUserId",
                        column: x => x.PortalUserId,
                        principalTable: "PortalUsers",
                        principalColumn: "PortalUserId",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MarkedNoShowAt = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClinicianAvailabilities", x => x.AvailabilityId);
                    table.ForeignKey(
                        name: "FK_ClinicianAvailabilities_Clinicians_ClinicianId",
                        column: x => x.ClinicianId,
                        principalTable: "Clinicians",
                        principalColumn: "ClinicianId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Consultations_Clinicians_ClinicianId",
                        column: x => x.ClinicianId,
                        principalTable: "Clinicians",
                        principalColumn: "ClinicianId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AdmittedBy = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
                    ...
                    AdmissionPriority = table.Column<int>(type: "int", nullable: false),
                    Status = table.Column<int>(type: "int", nullable: false),
                    ...
                    DischargedBy = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AdviceGiven = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    FollowUpRequired = table.Column<bool>(type: "bit", nullable: false),
                    FollowUpPeriodDays = table.Column<int>(type: "int", nullable: true),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CarePlans_Consultations_ConsultationId",
                        column: x => x.ConsultationId,
                        principalTable: "Consultations",
                        principalColumn: "ConsultationId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AmendsClinicalNoteId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ClinicalNotes_ClinicalNotes_AmendsClinicalNoteId",
                        column: x => x.AmendsClinicalNoteId,
                        principalTable: "ClinicalNotes",
                        principalColumn: "ClinicalNoteId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ClinicalNotes_Consultations_ConsultationId",
                        column: x => x.ConsultationId,
                        principalTable: "Consultations",
                        principalColumn: "ConsultationId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LabRequests_Consultations_ConsultationId",
                        column: x => x.ConsultationId,
                        principalTable: "Consultations",
                        principalColumn: "ConsultationId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Observations_Appointments_AppointmentId",
                        column: x => x.AppointmentId,
                        principalTable: "Appointments",
                        principalColumn: "AppointmentId");
                    table.ForeignKey(
                        name: "FK_Observations_Consultations_ConsultationId",
                        column: x => x.ConsultationId,
                        principalTable: "Consultations",
                        principalColumn: "ConsultationId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BedStatusHistoryId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    BedId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BedStatusHistories", x => x.BedStatusHistoryId);
                    table.ForeignKey(
                        name: "FK_BedStatusHistories_Admissions_AdmissionId",
                        column: x => x.AdmissionId,
                        principalTable: "Admissions",
                        principalColumn: "AdmissionId");
                    table.ForeignKey(
                        name: "FK_BedStatusHistories_Beds_BedId",
                        column: x => x.BedId,
                        principalTable: "Beds",
                        principalColumn: "BedId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClinicalAlerts", x => x.AlertId);
                    table.ForeignKey(
                        name: "FK_ClinicalAlerts_Admissions_AdmissionId",
                        column: x => x.AdmissionId,
                        principalTable: "Admissions",
                        principalColumn: "AdmissionId");
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ClinicalAlerts_Wards_WardId",
                        column: x => x.WardId,
                        principalTable: "Wards",
                        principalColumn: "WardId");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    DischargeChecklistId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    AdmissionId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ClinicalSummaryCompleted = table.Column<bool>(type: "bit", nullable: false),
                    MedicationReady = table.Column<bool>(type: "bit", nullable: false),
                    FollowUpBooked = table.Column<bool>(type: "bit", nullable: false),
                    BillingReviewed = table.Column<bool>(type: "bit", nullable: false),
                    TransportArranged = table.Column<bool>(type: "bit", nullable: false),
                    PatientInstructionsGiven = table.Column<bool>(type: "bit", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UpdatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DischargeChecklists_Admissions_AdmissionId",
                        column: x => x.AdmissionId,
                        principalTable: "Admissions",
                        principalColumn: "AdmissionId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RequiresSecondCheck = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UpdatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MedicationSchedules_Admissions_AdmissionId",
                        column: x => x.AdmissionId,
                        principalTable: "Admissions",
                        principalColumn: "AdmissionId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    NursingTaskId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    PatientId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    AdmissionId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    WardId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NursingTasks", x => x.NursingTaskId);
                    table.ForeignKey(
                        name: "FK_NursingTasks_Admissions_AdmissionId",
                        column: x => x.AdmissionId,
                        principalTable: "Admissions",
                        principalColumn: "AdmissionId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_NursingTasks_Wards_WardId",
                        column: x => x.WardId,
                        principalTable: "Wards",
                        principalColumn: "WardId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                name: "ObservationSchedules",
                columns: table => new
                {
                    ObservationScheduleId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    PatientId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    AdmissionId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ObservationSchedules", x => x.ObservationScheduleId);
                    table.ForeignKey(
                        name: "FK_ObservationSchedules_Admissions_AdmissionId",
                        column: x => x.AdmissionId,
                        principalTable: "Admissions",
                        principalColumn: "AdmissionId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ObservationSchedules_Patients_PatientId",
                        column: x => x.PatientId,
                        principalTable: "Patients",
                        principalColumn: "PatientId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                name: "PatientSafetyNotes",
                columns: table => new
                {
                    PatientSafetyNoteId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    PatientId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    AdmissionId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    NoteText = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PatientSafetyNotes", x => x.PatientSafetyNoteId);
                    table.ForeignKey(
                        name: "FK_PatientSafetyNotes_Admissions_AdmissionId",
                        column: x => x.AdmissionId,
                        principalTable: "Admissions",
                        principalColumn: "AdmissionId");
                    table.ForeignKey(
                        name: "FK_PatientSafetyNotes_Patients_PatientId",
                        column: x => x.PatientId,
                        principalTable: "Patients",
                        principalColumn: "PatientId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Transfers_Patients_PatientId",
                        column: x => x.PatientId,
                        principalTable: "Patients",
                        principalColumn: "PatientId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    LabTestItemId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    LabRequestId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LabTestItems", x => x.LabTestItemId);
                    table.ForeignKey(
                        name: "FK_LabTestItems_LabRequests_LabRequestId",
                        column: x => x.LabRequestId,
                        principalTable: "LabRequests",
                        principalColumn: "LabRequestId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PharmacyReviews", x => x.ReviewId);
                    table.ForeignKey(
                        name: "FK_PharmacyReviews_Prescriptions_PrescriptionId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<int>(type: "int", nullable: false),
                    ReasonNotGiven = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Notes = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SecondCheckedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SecondCheckedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MedicationAdministrationRecords", x => x.AdministrationId);
                    table.ForeignKey(
                        name: "FK_MedicationAdministrationRecords_Admissions_AdmissionId",
                        column: x => x.AdmissionId,
                        principalTable: "Admissions",
                        principalColumn: "AdmissionId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_MedicationAdministrationRecords_MedicationSchedules_MedicationScheduleId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Appointments_ClinicianId_StartTime_EndTime",
                table: "Appointments",
                columns: new[] { "ClinicianId", "StartTime", "EndTime" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Appointments_RoomId_StartTime_EndTime",
                table: "Appointments",
                columns: new[] { "RoomId", "StartTime", "EndTime" });

            migrationBuilder.CreateIndex(
                name: "IX_AppointmentTypes_DepartmentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BedStatusHistories_AdmissionId",
                table: "BedStatusHistories",
                column: "AdmissionId");

            migrationBuilder.CreateIndex(
                name: "IX_BedStatusHistories_BedId",
                table: "BedStatusHistories",
                column: "BedId");

            migrationBuilder.CreateIndex(
                name: "IX_CarePlans_ConsultationId",
                table: "CarePlans",
                column: "ConsultationId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClinicalAlerts_AdmissionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClinicalAlerts_WardId",
                table: "ClinicalAlerts",
                column: "WardId");

            migrationBuilder.CreateIndex(
                name: "IX_ClinicalNotes_AmendsClinicalNoteId",
                table: "ClinicalNotes",
                column: "AmendsClinicalNoteId");

            migrationBuilder.CreateIndex(
                name: "IX_ClinicalNotes_ConsultationId",
                table: "ClinicalNotes",
                column: "ConsultationId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClinicianAvailabilities_ClinicianId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Consultations_ClinicianId",
                table: "Consultations",
                column: "ClinicianId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DischargeChecklists_AdmissionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_IntegrationMessages_EndpointId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LabRequests_ConsultationId",
                table: "LabRequests",
                column: "ConsultationId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LabTestItems_LabRequestId",
                table: "LabTestItems",
                column: "LabRequestId");

            migrationBuilder.CreateIndex(
                name: "IX_MedicationAdministrationRecords_AdmissionId",
                table: "MedicationAdministrationRecords",
                column: "AdmissionId");

            migrationBuilder.CreateIndex(
                name: "IX_MedicationAdministrationRecords_MedicationScheduleId",
                table: "MedicationAdministrationRecords",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MedicationSchedules_AdmissionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NursingTasks_AdmissionId",
                table: "NursingTasks",
                column: "AdmissionId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NursingTasks_WardId",
                table: "NursingTasks",
                column: "WardId");

            migrationBuilder.CreateIndex(
                name: "IX_Observations_AppointmentId",
                table: "Observations",
                column: "AppointmentId");

            migrationBuilder.CreateIndex(
                name: "IX_Observations_ConsultationId",
                table: "Observations",
                column: "ConsultationId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ObservationSchedules_AdmissionId",
                table: "ObservationSchedules",
                column: "AdmissionId");

            migrationBuilder.CreateIndex(
                name: "IX_ObservationSchedules_PatientId",
                table: "ObservationSchedules",
                column: "PatientId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PatientSafetyNotes_AdmissionId",
                table: "PatientSafetyNotes",
                column: "AdmissionId");

            migrationBuilder.CreateIndex(
                name: "IX_PatientSafetyNotes_PatientId",
                table: "PatientSafetyNotes",
                column: "PatientId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PharmacyReviews_PrescriptionId",
                table: "PharmacyReviews",
                column: "PrescriptionId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_PortalNotifications_PortalUserId",
                table: "PortalNotifications",
                column: "PortalUserId");

            migrationBuilder.CreateIndex(
                name: "IX_PortalUsers_PatientId",
                table: "PortalUsers",
                column: "PatientId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServiceCatalogues_DepartmentId",
                table: "ServiceCatalogues",
                column: "DepartmentId");

            migrationBuilder.CreateIndex(
                name: "IX_ServiceCatalogues_ServiceCode",
                table: "ServiceCatalogues",
                column: "ServiceCode",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WaitingListEntries_AppointmentTypeId",
                table: "WaitingListEntries",
                column: "AppointmentTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_WaitingListEntries_DepartmentId",
                table: "WaitingListEntries",
                column: "DepartmentId");
